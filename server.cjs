...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Inclusive Special Education Support System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Educator Support Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "educator_support_record_records";
'use strict';
